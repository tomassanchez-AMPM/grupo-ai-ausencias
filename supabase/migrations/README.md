...
Estas migraciones ya están aplicadas en el proyecto Supabase
«GRUPO A/I - Ausencias» (ref `ozpbyncnsdxzocqczxzu`). Se guardan aquí como registro versionado; para un
